...
namespace Cyclops
{
    ...
    // Set Int Array 1
    void Shader::SetUniform1iv(const std::string& name, int32_t count, int32_t* value)
    {
    ...
    uint32_t Shader::CompileShader(uint32_t type, const std::string& source)
    {
        ...
        // Version Injection for future MacOS support
        std::string versionString;

        #ifdef CYCLOPS_PLATFORM_MAC
                versionString = "#version 410 core\n";
        #else
                // Windows/Linux usually support the latest. 
                // We default to 450, but you could check GL_MAJOR_VERSION at runtime too.
                versionString = "#version 450 core\n";
        #endif

        std::string finalSource = versionString + source;

        //// --- DEBUG: PRINT THE FINAL SHADER ---
        //// This will show us exactly what the GPU sees.
        //std::cout << "==========================================" << std::endl;
        //std::cout << "COMPILING SHADER (" << (type == GL_VERTEX_SHADER ? "Vertex" : "Fragment") << "):" << std::endl;
